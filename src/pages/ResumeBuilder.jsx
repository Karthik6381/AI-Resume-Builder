...
import { ArrowLeftIcon, Briefcase, ChevronLeft,ChevronRight, Download, DownloadIcon, EyeIcon, EyeOffIcon, FileText, FolderIcon, GraduationCap, Share2, Share2Icon, Sparkles, User } from 'lucide-react';
...
const handleshare = () =>{
  ...
  alert('Share not supported on this brower.')
}
}
          ...
          <div className='relative rounded-lg overflow-hidden'>
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
              ...
              <hr className='absolute top-0 left-0 h-1 bg-gradient-to-r from-green-500 to-green-600 border-none transition-all duration-2000'
               ...
               <button className='bg-gradient-to-br from-green-100 to-green-200 right-green-300 text-green-600 ring hover:ring-green-400 transition-all rounded-md px-6 py-2 mt-6 text-sm'>
                Save Changes               </button>
          ...
          <div className='className="lg:col-span-7 max-lg:mt-6"'>
            <div className='relative w-full'>
              <div className='absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2'>
               {resumeData.public && (
                <button onClick={handleshare} className='flex items-center p-2 px-4 gap-2 text-xs bg-gradient-to-br from-blue-100 to-blue-100 to-blue-200 text-blue-600 rounded-lg ring-blue-300 hover:ring transition-colors '>
